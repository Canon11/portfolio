            ...
            <v-card class="px-2 py-2">
                ...
                <div class="text-xs-center">
                    <div v-for="(skill, index) in skills" :key="index">
                        ...
                        <v-chip outline color="primary" v-for="(content, index) in skill.contents" :key="index">
                            {{ content }}
                        </v-chip>
                    </div>
                </div>
...
export default {
    data: () => ({
        ...
        skills: [{
            ...
            {
                title: 'Cloud',
                contents: ['ELB', 'ElasticBeanstalk', 'CloudWatch', 'Aurora', 'CloudFront', 'GAE', 'GKE', 'CloudSQL']
            },
            {
                title: 'MicroService',
                contents: ['Docker', 'Kubernetes', 'CircleCI', 'UnitTest', 'Selenium', 'gRPC']
            },
            {
                title: 'Other',
                contents: ['MySQL', 'Gulp', 'AWS Solutions Architect Associate', 'WordPress']
            }
        ]
    }),
    methods: {
